...
В колонке «execute» указано число тактов исполнения.

| Мнемоника | Опкод | Операнд | Действие | execute |
|---|---|---|---|---|
...
| `POP_IND`  | 0x06 | -      | `val=DS.pop(); addr=DS.pop(); MEM[addr]=val`    | 2 |
...
| `DIV`      | 0x0F | -      | `DS.push(DS.pop() ÷ DS.pop())` (целочисленное)  | 1 |
...
Tick: 0003 | pc: 0011 | DS: [] | EI: 1 | carry: False | Instr: PUSH_M 0
Tick: 0009 | pc: 0012 | DS: [13] | EI: 1 | carry: False | Instr: POP_M 14
 ...
Output: Hello, World!
Overall quantity of ticks: 991
